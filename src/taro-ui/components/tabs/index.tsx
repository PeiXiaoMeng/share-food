  ...
  public render(): JSX.Element {
    ...
    const tabItems = tabList.map((item, idx) => {
      ...
      return (
        <View
          className={itemCls}
          id={`${keyPrefix}tab${idx}`}
          key={keyPrefix + (item.key || item.title)}
      ...
      >
        {scroll ? (
          <ScrollView
            ...
            scrollIntoView={keyPrefix + _scrollIntoView}
          >
            {tabItems}
          </ScrollView>
        ) : (
          <View id={keyPrefix + this._tabId} className='at-tabs__header'>
            {tabItems}
          </View>
        )}
        <View
